...
abstract: |
  **Objective:** Compare risk-based methods for individualizing treatment 
  ...
  knots); an adaptive model selection method using Akaike’s Information 
...
constant relative treatment effect had the lowest RMSE under the base case
scenario of constant relative treatment effects (Figure
