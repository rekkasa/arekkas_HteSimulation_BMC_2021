...
for non-monotonic deviations with no treatment-related harms)
compared to the linear interaction approach
(median RMSE
...
average, there was increased variability in error rates in the case of
strong linear and non-monotonic deviations. In these scenarios, the adaptive approach often selected the constant treatment effect model
...
The linear interaction model was most stable in compared to the other
...
As for calibration, the constant effects model outperformed all other
models in the case of true constant treatment effects, but it was
miscalibrated for all deviation scenarios (Figure
