...
For the second part linear and quadratic deviations from the
assumption of constant relative effect are considered. We also
consider different intensity levels of these deviations. The settings
for these deviations are defined in Table \@ref(tab:tab1) and result
in the effects of Figure \@ref(fig:fig1).
...
Finally, we consider 3 additional scenarios of interaction of
individual covariates with treatment. These scenarios include a 4 weak
interactions ($\text{OR}_{t_x=1} / \text{OR}_{t_x=0}=0.82$), 4 strong
interactions ($\text{OR}_{t_x=1} / \text{OR}_{t_x=0}=0.61$), and 2
weak and 2 strong interactions (Table \@ref(tab:tab2)).
...
\newpage
\begin{landscape}
```{r adaptiveBase, cache=FALSE, echo=FALSE, fig.cap="Adaptive model selection rates for the base case scenario true prediction AUC of 0.75, sample size of 4250", fig.show="hold", out.width = '100%'}
...
\newpage
\begin{landscape}
```{r adaptiveSampleSize, cache=FALSE, echo=FALSE, fig.cap="Adaptive model selection rates for sample size of 17000.", fig.show="hold", out.width = '100%'}
...
\newpage
\begin{landscape}
```{r adaptiveAuc, cache=FALSE, echo=FALSE, fig.cap="Adaptive model selection rates for true prediction AUC of 0.85.", fig.show="hold", out.width = '100%'}
...
\newpage
```{r rmseHighBase, cache=FALSE, echo=FALSE, fig.cap="RMSE high effect base", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here("figures/rmse_high_base.tiff")))
# knitr::include_graphics(here::here("figures/calibration_base.png"))
```

\newpage
```{r rmseHighSampleSize, cache=FALSE, echo=FALSE, fig.cap="RMSE high effect sample size", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here("figures/rmse_high_sample_size.tiff")))
# knitr::include_graphics(here::here("figures/calibration_base.png"))
```

\newpage
```{r rmseHighAuc, cache=FALSE, echo=FALSE, fig.cap="RMSE high effect auc", fig.show="hold", out.width = '100%'}
