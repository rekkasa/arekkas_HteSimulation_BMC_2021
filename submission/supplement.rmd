...
```{r rmseInteractionPositive, cache=TRUE, echo=FALSE, fig.cap="RMSE of the considered methods across 500 replcations calculated in a simulated sample of size 500,000. AUC is 0.85 rather than in Figure \\ref{fig:rmseHighBase}.", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here("figures/rmse_interaction_positive.tiff")))
# knitr::include_graphics(here::here("figures/calibration_base.png"))
```
```{r rmseInteractionNegative, cache=TRUE, echo=FALSE, fig.cap="RMSE of the considered methods across 500 replcations calculated in a simulated sample of size 500,000. AUC is 0.85 rather than in Figure \\ref{fig:rmseHighBase}.", fig.show="hold", out.width = '100%'}
grid::grid.raster(tiff::readTIFF(here("figures/rmse_interaction_negative.tiff")))
# knitr::include_graphics(here::here("figures/calibration_base.png"))
```
```{r rmseInteractionCombined, cache=TRUE, echo=FALSE, fig.cap="RMSE of the considered methods across 500 replcations calculated in a simulated sample of size 500,000. AUC is 0.85 rather than in Figure \\ref{fig:rmseHighBase}.", fig.show="hold", out.width = '100%'}
...
&\beta_4 I(\text{Killip}=IV) + \beta_5ceil(\text{sysbp}, 120) + lsp(\text{pulse}, 50) +\\
&\beta_6 I(\text{pmi}=yes)+\beta_8 I(\text{miloc}=Anterior) + \\
&\beta_9 I(\text{miloc}=Other) + \gamma t_x
\end{aligned}
(\#eq:gusto2)
\end{equation}
