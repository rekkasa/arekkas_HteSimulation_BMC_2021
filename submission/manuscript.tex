...
\begin{figure}
\includegraphics[width=1\linewidth]{manuscript_files/figure-latex/rmsesamplesize-1} \caption{RMSE of the considered methods across 500 replications calculated in simulated samples of size 17,000 rather than 4,250 in Figure \ref{fig:rmsebase}}\label{fig:rmsesamplesize}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{manuscript_files/figure-latex/rmseauc-1} \caption{RMSE of the considered methods across 500 replications calculated in a simulated samples 4,250. True prediction AUC of 0.85.}\label{fig:rmseauc}
\end{figure}
...
model development can be found in the supplement (Section XX).

We used the risk linear predictor to fit a constant treatment effect
...
found in Supplement, Section XX. Future simulation studies could explore
